...
import * as PropagationStories from "./plain/propagation.stories";
...
<StoryAndSource of={PropagationStories.Scenario1} id="stories-propagation--scenario-1" />
...
<StoryAndSource of={PropagationStories.Scenario2} id="stories-propagation--scenario-2" />
...
<StoryAndSource of={PropagationStories.Scenario3} id="stories-propagation--scenario-3" />
...
<StoryAndSource of={PropagationStories.Scenario4} id="stories-propagation--scenario-4" />
